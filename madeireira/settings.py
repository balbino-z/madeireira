"""
Django settings for madeireira project.
...
WSGI_APPLICATION = 'madeireira.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'madeireira',  # Nome do banco
        'USER': 'madeireira_user',  # Usuário
        'PASSWORD': 'ulwqAqwi0GnDvYE0EpPIZ5CYeMgdKNMy',  # Senha
        'HOST': 'dpg-cu8jkdpopnds73d6tgpg-a.oregon-postgres.render.com',  # Hostname
        'PORT': '5432',  # Porta
        'OPTIONS': {
...
# Diretórios de onde o Django coleta arquivos estáticos
STATICFILES_DIRS = [
